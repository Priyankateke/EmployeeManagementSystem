...
debugger;
    ...
    //Fetch employee data
    fetchEmployee() {
        axios.get('http://localhost:8081/getEmployee/'+this.props.match.params.empid, {
            responseType: 'json'
        }).then(
            ...
            (result) => {
                this.setState({
                    isLoaded: true,
                    items: result.data,
                    empid: parseInt(result.data.Empid),
    ...
    storeData() {
        ...
        $.ajax({
            ...
            url: "http://localhost:8081/editUser",
            ...
            <div className="auth-wrapper" >
                <div className="auth-inner">
                    <form onSubmit={this.onSubmit} noValidate>
                        ...
                        <button type="submit" align="center" className="btn btn-success btn-block">Update Employee</button>
                    </form>
                </div>
            </div>
        );
